    ...
    <>
      <div ref={containerRef} className="relative">
        <button
          ...
          className="w-10 h-10 shadow-xs bg-bg-secondary dark:bg-bg-secondary-dark rounded-full flex items-center justify-center border-2 border-border dark:border-transparent dark:pseudo-border-top transition-colors duration-300 group hover:border-blue dark:hover:border-transparent relative"
        ...
        {panelOpen && <NotificationPanel onClose={() => setPanelOpen(false)} onSelect={handleSelect} />}
      </div>
