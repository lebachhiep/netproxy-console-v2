                  ...
                  if (isCartItem) {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Đơn giá */}
                        <div className="w-[42px] text-center text-primary dark:text-primary-dark font-semibold">${orderItem.price.toFixed(2)}</div>
                        ...
                        {/* Tổng */}
                        <div className="w-[60px] text-center text-text-hi dark:text-text-hi-dark">${(orderItem.price * orderItem.quantity).toFixed(2)}</div>

                        {/* Nút xóa */}
                        <IconButton className="w-8 h-8" icon={<Delete className="w-5 h-5" />} onClick={() => onRemove && onRemove(orderItem.country)} aria-label="Xóa khỏi giỏ hàng" />
                      </div>
                    );
                  }
                })
